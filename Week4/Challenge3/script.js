...
function show(button_element) {
    ...
    */
    ...
    // let cur_name = button_element.innerText;
    // console.log(cur_name);
    let cur_id = button_element.getAttribute('id');
    // console.log(cur_id);
    let fact = facts[cur_id];
    // console.log(fact);

    let name_res = document.getElementById('ta-fun-fact');
    name_res.innerText = fact;
    ...
    let pic_res = document.getElementById('ta-photo');
    pic_res.setAttribute('src', 'photos/' + cur_id + '.jpg');
    ...
    // reset everything
    bttns = document.getElementsByTagName('button');
    for (bttn of bttns) {
        bttn.style.backgroundColor = 'darkblue';
